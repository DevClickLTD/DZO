        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-4">
            <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pt-64 pb-9 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
              <img
                alt="Основни покрития при здравно осигуряване"
                src="osnovni-pokritia-zdravno-osigoriavane.jpg"
              ...
              >
                <div
                  ...
                  className="aspect-1097/845 w-[68.5625rem] bg-linear-to-tr from-[#129160] to-[#129160] opacity-40"
                />
              </div>
              <figure className="relative isolate">
                ...
                <p className="mt-6 text-xl/8 font-semibold text-white">
                  Пакетни здравни решения за корпоративни клиенти. Подходящо за
                  фирми с над 5 служители.
                </p>
                <figcaption className="mt-6 text-sm/6 text-gray-300">
                  С опция за добавяне на член на семейството
                </figcaption>
              </figure>
            </div>
          </div>
