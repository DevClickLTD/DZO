...
export const metadata = {
  title: "За нас - Удостоверение | ДЗО",
  description:
    "Удостоверение за регистрация на Хорпорекс България ЕООД в комисията за финансов надзор за извършване на дейност по застрахователно посредничество.",
  openGraph: {
    title: "За нас - Удостоверение | ДЗО",
    description:
      "Удостоверение за регистрация на Хорпорекс България ЕООД в комисията за финансов надзор за извършване на дейност по застрахователно посредничество.",
    images: [
      {
        url: "/Удостоверение-№762_ЗБ_30_06_2021г.webp",
        width: 800,
        height: 1000,
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative bg-white rounded-2xl shadow-2xl p-12 mx-auto max-w-5xl">
          {/* Decorative corners */}
          <div className="absolute top-4 left-4 w-8 h-8 border-l-4 border-t-4 border-green-600 rounded-tl-lg"></div>
          <div className="absolute top-4 right-4 w-8 h-8 border-r-4 border-t-4 border-green-600 rounded-tr-lg"></div>
          <div className="absolute bottom-4 left-4 w-8 h-8 border-l-4 border-b-4 border-green-600 rounded-bl-lg"></div>
          <div className="absolute bottom-4 right-4 w-8 h-8 border-r-4 border-b-4 border-green-600 rounded-br-lg"></div>
